...
# psycopg needs libpq at runtime when not using the [binary] wheel extras alone on some platforms.
# curl is only needed to fetch the Claude Code CLI installer below.
